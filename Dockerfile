...
# PORT is injected by Render at runtime (defaults to 8000 for local Docker)
CMD python scripts/setup_models.py && uvicorn api.main:app --host 0.0.0.0 --port ${PORT:-8000} --workers 1
