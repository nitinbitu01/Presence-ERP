      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <div>
          ...
          <p className="mt-0.5 text-xs text-muted-foreground">
            Borderline face-match enrollments (similarity 70–82%). Approve to confirm legitimacy,
            or Reject to deactivate and require re-enrollment.
          </p>
        </div>
        <button
                ...
                return (
                  <tr key={row.id} className="hover:bg-muted/30 transition-colors">
                    ...
                    <td className="px-3 py-2.5 text-center">
                      <span className={simColor(row.similarity)}>
                        {simPercent(row.similarity)}
                      </span>
                    </td>
