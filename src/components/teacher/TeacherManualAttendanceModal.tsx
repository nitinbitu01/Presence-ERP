        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div className="space-y-1">
            ...
            >
              ...
              <option value="medical_od_exemption">🏥 Medical / Official Duty (OD) Exemption</option>
          ...
          <div className="rounded-md bg-amber-500/10 border border-amber-500/20 p-2.5 text-[11px] text-amber-700 dark:text-amber-400 flex items-start gap-2">
            ...
            <span>
              This override will mark the student <strong>Present</strong> and permanently log your Teacher ID, timestamp, and reason for audit compliance.
            </span>
          </div>

          {error && <div className="rounded-md bg-destructive/10 border border-destructive/30 p-2 text-xs text-destructive">{error}</div>}
