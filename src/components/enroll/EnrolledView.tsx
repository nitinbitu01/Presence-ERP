...
export function EnrolledView({
  state, depts, progs, deviceLabel, setDeviceLabel,
  onRegisterDevice, onRemoveDevice,
  onWithdrawBiometric, onAdminReset, onSignOut,
}: Props) {
  ...
  return (
    <div className="mx-auto max-w-lg px-6 py-10">
      ...
      <ConfirmDialog
        ...
        cancelLabel="Keep it"
        destructive
        onConfirm={() => { setWithdrawDialogOpen(false); onWithdrawBiometric(); }}
      ...
      <ConfirmDialog
        ...
        cancelLabel="Cancel"
        destructive
        onConfirm={() => { setAdminResetDialogOpen(false); onAdminReset(); }}
