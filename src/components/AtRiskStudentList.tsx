        ...
        <table className="w-full text-sm text-left">
          ...
          <tbody className="divide-y divide-border">
            {sortedStudents.map((s) => {
              const bgClass = 
                s.urgency === 'critical' ? 'bg-red-50/50 hover:bg-red-50 dark:bg-red-950/10 dark:hover:bg-red-950/20' :
                s.urgency === 'high' ? 'bg-amber-50/50 hover:bg-amber-50 dark:bg-amber-950/10 dark:hover:bg-amber-950/20' :
                'bg-card hover:bg-muted/30';
              
              const badgeClass = 
                s.urgency === 'critical' ? 'bg-red-100 text-red-700 dark:bg-red-900/50 dark:text-red-300 border-red-200' :
                s.urgency === 'high' ? 'bg-amber-100 text-amber-700 dark:bg-amber-900/50 dark:text-amber-300 border-amber-200' :
