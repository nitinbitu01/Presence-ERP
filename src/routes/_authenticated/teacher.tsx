...
function TeacherDashboard() {
  ...
  if (!isTeacher) return (
    <div className="mx-auto max-w-lg px-6 py-20">
      ...
      >
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-destructive/5 to-rose-500/5" aria-hidden />
        <motion.div
        ...
        <div>
          ...
          <p className="mt-2 text-xs text-muted-foreground max-w-xs mx-auto leading-relaxed">
            You are logged in as a Student. Access to the Teacher Command Center is restricted to authorized faculty members.
          </p>
        </div>
        <motion.button
          type="button"
