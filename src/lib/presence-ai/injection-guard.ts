...
export async function semanticInjectCheck(
  input: string,
  apiKey: string,
): Promise<boolean> {
...
SAFE = a normal question about attendance, grades, or university systems.`,
      ...
      signal: typeof AbortSignal !== 'undefined' && typeof (AbortSignal as any).timeout === 'function' ? (AbortSignal as any).timeout(3_000) : undefined,
    });
