...
export function DevicePanel({
  ...
  return (
    <section aria-label="Registered devices" className="border-t border-border px-6 py-4">
      <p className="text-xs font-semibold text-foreground mb-2">Registered Devices</p>
